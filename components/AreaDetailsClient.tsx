          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                {area.lifestyle.map((item: string, index: number) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    {area.amenities.parks.map((park: string, index: number) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {area.amenities.shopping.map((shop: string, index: number) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {area.amenities.dining.map((restaurant: string, index: number) => (
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {area.photos.map((photo: string, index: number) => (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <ul className="space-y-2 mb-6">
                {area.schools.map((school: string, index: number) => (
              ...
              <ul className="space-y-2">
                {area.transit.map((transit: string, index: number) => (
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                {area.propertyTypes.map((type: string, index: number) => (
